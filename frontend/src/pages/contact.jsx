                  ...
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-3 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 input-focus"
                    ...
                    <button 
                      type="submit" 
                      disabled={isLoading}
                      className={`bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-md transition-all duration-300 w-full md:w-auto flex items-center justify-center space-x-2 group ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`}
                    >
                    ...
                    {formStatus === 'success' && (
                      <div className="text-green-600 mt-4 p-3 bg-green-50 rounded-md">
