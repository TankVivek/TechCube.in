    ...
    >
      <div className="container-corporate flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="#contact" className="hidden sm:inline-flex items-center justify-center bg-slate-900 dark:bg-white text-white dark:text-slate-900 px-5 py-2.5 rounded-md text-sm font-bold hover:bg-slate-800 dark:hover:bg-slate-100 transition-colors">
            Get Started
          </a>
          {/* Mobile Menu Button */}
          <button
