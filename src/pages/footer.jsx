      ...
      <div className="bg-blue-900 py-12 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0 md:mr-8">
            ...
            <p className="text-blue-100">Subscribe to our newsletter for the latest tech insights</p>
          </div>
          ...
          <form className="flex flex-col sm:flex-row w-full max-w-md gap-3">
            <input 
              ...
              className="px-4 py-3 rounded-lg flex-grow focus:ring-2 focus:ring-blue-500 outline-none"
              required
            />
            <button 
              type="submit" 
      ...
      <div className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-6">
                <img src={logo} alt="TechCube Logo" className="h-14 w-13" />
                {/* <h3 className="text-xl font-bold text-white">TechCube</h3> */}
              </div>
              <p className="text-gray-400 mb-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={label}>
                    <a href={url} className="text-gray-400 hover:text-white transition-colors duration-200">
                      {label}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-4">
                {/* {['facebook', 'twitter', 'instagram', 'linkedin'].map((platform) => (
                  <a 
                    key={platform}
                    href={`https://${platform}.com/techcube`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-white transition-colors duration-200"
                    aria-label={`TechCube on ${platform}`}
                  >  */}
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {currentYear} TechCube. All rights reserved.
            </p>
            ...
            <div className="flex space-x-6">
              ...
              <a href="/sitemap.xml" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">
                Sitemap
              </a>
            </div>
          </div>
